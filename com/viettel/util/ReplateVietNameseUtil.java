...
public class ReplateVietNameseUtil {
	...
	public static String removeVietNamese(String s)
	{
		...
		String data=s.trim().replaceAll(" +", " ").toLowerCase();
	...
	public static void main(String[] args) {
		String result=ReplateVietNameseUtil.toUrlFriendly(" lê  Thành   Long ");
		System.out.println(result);
		
		
		result=ReplateVietNameseUtil.removeVietNamese(" lê  Thành   Long ");
