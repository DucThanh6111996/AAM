...
public interface IimClientService {
    public Module findModuleById(String nationCode, Long id) throws AppException, com.viettel.exception.AppException;
    ...
    public ServiceDatabase findServiceDbById(String nationCode, Long id) throws AppException, com.viettel.exception.AppException;
