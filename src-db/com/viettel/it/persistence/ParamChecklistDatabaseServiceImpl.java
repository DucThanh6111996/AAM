...
*/
@Scope("session")
@Service(value = "paramChecklistDatabaseService")
public class ParamChecklistDatabaseServiceImpl  extends GenericDaoImplNewV2<ParamChecklistDatabase, Long> implements  Serializable{
