...
*/
@Scope("session")
@Service(value = "actionDetailService")
public class ActionDetailServiceImpl  extends GenericDaoImplNewV2<ActionDetail, Long> implements  Serializable{
