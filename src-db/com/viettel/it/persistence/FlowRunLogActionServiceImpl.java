...
import com.viettel.it.model.FlowRunLogAction;
...
*/
@Scope("session")
@Service(value = "flowRunLogActionService")
public class FlowRunLogActionServiceImpl  extends GenericDaoImplNewV2<FlowRunLogAction, Long>
		implements GenericDaoServiceNewV2<FlowRunLogAction, Long>, Serializable{
