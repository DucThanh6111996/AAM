...
*/
@Scope("session")
@Service(value = "nodeTypeService")
public class NodeTypeServiceImpl  extends GenericDaoImplNewV2<NodeType, Long> implements  Serializable{
