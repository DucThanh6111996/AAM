...
import com.viettel.it.model.PlanIpServiceOam;
...
*/
@Scope("session")
@Service(value = "planIpServiceOamService")
public class PlanIpServiceOamServiceImpl  extends GenericDaoImplNewV2<PlanIpServiceOam, Long> implements  Serializable{
