...
import com.viettel.it.model.ItServices;
...
*/
@Scope("session")
@Service(value = "itServices")
public class ItServicesImpl extends GenericDaoImplNewV2<ItServices, Long>
		implements GenericDaoServiceNewV2<ItServices, Long>, Serializable {
