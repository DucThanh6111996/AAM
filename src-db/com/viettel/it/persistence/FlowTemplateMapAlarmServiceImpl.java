...
import com.viettel.it.model.FlowTemplateMapAlarm;
...
*/
@Scope("session")
@Service(value = "flowTemplateMapAlarmService")
public class FlowTemplateMapAlarmServiceImpl extends GenericDaoImplNewV2<FlowTemplateMapAlarm, Long> implements  Serializable{
