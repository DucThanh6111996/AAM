...
*/
@Scope("session")
@Service(value = "paramInputService")
public class ParamInputServiceImpl  extends GenericDaoImplNewV2<ParamInput, Long> implements  Serializable{
