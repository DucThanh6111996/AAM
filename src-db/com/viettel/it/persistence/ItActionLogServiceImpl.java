...
*/
@Scope("session")
@Service(value = "itActionLogService")
public class ItActionLogServiceImpl extends GenericDaoImplNewV2<ItActionLog, Long>
		implements GenericDaoServiceNewV2<ItActionLog, Long>, Serializable {
