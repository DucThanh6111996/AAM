...
import com.viettel.it.model.DbParamDatafile;
...
*/
@Scope("session")
@Service(value = "dbParamDatafileService")
public class DbParamDatafileServiceImpl  extends GenericDaoImplNewV2<DbParamDatafile, String> implements  Serializable{
