...
import com.viettel.it.model.AutoConfigNodeTemplate;
...
*/
@Scope("session")
@Service(value = "autoConfNodeTemService")
public class AutoConfNodeTemServiceImpl extends GenericDaoImplNewV2<AutoConfigNodeTemplate, Long> implements  Serializable{
