...
import com.viettel.it.model.ParamExportDumpSizeDb;
...
*/
@Scope("session")
@Service(value = "paramExportDumpSizeDbService")
public class ParamExportDumpSizeDbServiceImpl  extends GenericDaoImplNewV2<ParamExportDumpSizeDb, String> implements  Serializable{
