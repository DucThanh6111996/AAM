...
/**
* CommandTelnetParserServiceImpl.java
*
...
*/
@Scope("session")
@Service(value = "commandTelnetParserService")
public class CommandTelnetParserServiceImpl  extends GenericDaoImplNewV2<CommandTelnetParser, Long> implements  Serializable{
