...
import com.viettel.it.model.ParamExportDb;
...
*/
@Scope("session")
@Service(value = "paramExportDbService")
public class ParamExportDbServiceImpl  extends GenericDaoImplNewV2<ParamExportDb, Long> implements  Serializable{
