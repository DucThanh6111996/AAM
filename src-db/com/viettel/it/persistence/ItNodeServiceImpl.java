...
*/
@Scope("session")
@Service(value = "itNodeService")
public class ItNodeServiceImpl extends GenericDaoImplNewV2<ItNode, Long>
		implements GenericDaoServiceNewV2<ItNode, Long>, Serializable {
