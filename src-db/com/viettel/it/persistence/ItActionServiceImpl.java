...
import com.viettel.it.model.ItAction;
...
*/
@Scope("session")
@Service(value = "itActionService")
public class ItActionServiceImpl  extends GenericDaoImplNewV2<ItAction, Long>
		implements GenericDaoServiceNewV2<ItAction, Long>, Serializable {
